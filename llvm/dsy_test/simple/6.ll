...
if.then2:                                         ; preds = %if.else
  %sub = sub nsw i32 %4, %6
  store i32 %sub, i32* %c, align 4, !tbaa !3
  br label %if.end4

if.else3:                                         ; preds = %if.else
  %mul = mul nsw i32 %6, %4
  store i32 %mul, i32* %c, align 4, !tbaa !3
  br label %if.end4
...
if.then6:                                         ; preds = %if.end4
  ...
  %9 = load i32, i32* %d, align 4, !tbaa !3
  %add7 = add nsw i32 %9, %8
  store i32 %add7, i32* %c, align 4, !tbaa !3
  br label %if.end8

if.end8:                                          ; preds = %if.then6, %if.end4
  call void @_Z14registerOutputPKcPvi(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* nonnull %2, i32 4)
